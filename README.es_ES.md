...
- **Ofuscación completa de AmneziaWG 2.0** — Jc/Jmin/Jmax (paquetes basura), S1–S4 (relleno de paquetes), H1–H4 (cabeceras mágicas) y los 5 espacios de paquete de firma (I1–I5) — cada uno generable con un clic como un paquete que imita DNS/STUN/SIP/QUIC, un ClientHello TLS real de Chrome/Firefox/Safari, o como pura aleatoriedad — todos editables por entrada, además de un modo compatible con 1.x para clientes más antiguos.
