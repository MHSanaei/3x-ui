...
update_menu() {
    ...
    if replace_xui_script "https://raw.githubusercontent.com/kuzzrus/3x-ui-awg/main/x-ui.sh" "false"; then
...
update_shell() {
    if replace_xui_script "https://github.com/kuzzrus/3x-ui-awg/raw/main/x-ui.sh" "true"; then
