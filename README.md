...
- **Full AmneziaWG 2.0 obfuscation** — Jc/Jmin/Jmax (junk packets), S1–S4 (packet padding), H1–H4 (magic headers), and all 5 CPS signature-packet slots (I1–I5), each generatable as a DNS/STUN/SIP/QUIC-mimicry packet or pure randomness with one click — all editable per-inbound, plus a 1.x-compatible fallback for older clients.
