...
- **Per-client management** — traffic quotas, traffic ratio (billed usage multiplier), expiry dates, IP limits, live online status, and one-click share links, QR codes, and subscriptions.
