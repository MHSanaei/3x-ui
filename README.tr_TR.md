...
- **Tam AmneziaWG 2.0 gizlemesi** — Jc/Jmin/Jmax (çöp paketler), S1–S4 (paket dolgusu), H1–H4 (sihirli başlıklar) ve tüm 5 imza paketi yuvası (I1–I5) — her biri tek tıkla DNS/STUN/SIP/QUIC taklidi bir paket veya saf rastgelelik olarak üretilebilir — hepsi gelen bağlantı başına düzenlenebilir, ayrıca eski istemciler için 1.x uyumlu bir mod da bulunur.
