...
Önemli: panel hazır şablon **sunmaz** — kendi temanızı kendiniz oluşturmanız gerekir. Oluşturma talimatları ve kullanılabilir değişkenlerin listesi [`docs/custom-subscription-templates.md`](https://github.com/MHSanaei/3x-ui/blob/main/docs/custom-subscription-templates.md) dosyasındadır.
