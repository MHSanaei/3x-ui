...
Важливо: панель **не постачає** готових шаблонів — свою тему потрібно створити самостійно. Інструкція зі створення та список доступних змінних — у [`docs/custom-subscription-templates.md`](https://github.com/MHSanaei/3x-ui/blob/main/docs/custom-subscription-templates.md).
