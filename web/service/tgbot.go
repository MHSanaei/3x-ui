...
func (t *Tgbot) asnwerCallback(callbackQuery *telego.CallbackQuery, isAdmin bool) {
    ...
    numericKeyboard := tgbotapi.NewInlineKeyboardMarkup(
        tgbotapi.NewInlineKeyboardRow(
            tgbotapi.NewInlineKeyboardButtonData("اتوماتیک", "auto"),
            tgbotapi.NewInlineKeyboardButtonData("دستی", "manual"),
        ),
    )

    if update.CallbackQuery != nil && update.CallbackQuery.Data == "auto" {
        fmt.Println("به زودی")
    } else if update.CallbackQuery != nil && update.CallbackQuery.Data == "manual" {
        fmt.Println("به زودی تر")
    }
	case "commands":    
