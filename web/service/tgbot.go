...
func (t *Tgbot) SendAnswer(chatId int64, msg string, isAdmin bool) {
	...
	if isAdmin {
		params.ReplyMarkup = append(numericKeyboard.InlineKeyboardRows(), additionalButtons)
	} else {
		params.ReplyMarkup = append(numericKeyboardClient.InlineKeyboardRows(), additionalButtons)
	}
