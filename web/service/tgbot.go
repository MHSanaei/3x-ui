...
func (t *Tgbot) asnwerCallback(callbackQuery *telego.CallbackQuery, isAdmin bool) {
	...
	case "hamrah_e_aval":
		...
		for _, domain := range domains {
			...
			if err != nil {
				t.SendMsgToTgbot(chatId, "Error: "+err.Error(), tu.ReplyKeyboardRemove())
				continue
			}
	...
	case "irancell":
		t.SendMsgToTgbot(chatId, "Here are the Irancell IPs for Cloudflare:")
		// TODO: add code to fetch and display Irancell IPs
	}
}
