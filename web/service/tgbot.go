...
func (t *Tgbot) asnwerCallback(callbackQuery *telego.CallbackQuery, isAdmin bool) {
    ...
    operators := map[string][]string{
        "همراه اول": {"mci.ircf.space", "mcix.ircf.space", "mci.eqjgkx.xyz", "mcicn.adihnrr.eu.org", "mci.vcdn.online", "mci.ma7ta.online", "mci.boby66600.eu.org", "mci.jangal.icu", "mci.filna.cloud", "mcih.hamedgeek.top"},
        "ایرانسل": {"mtn.ircf.space", "mtnx.ircf.space", "irc.eqjgkx.xyz", "irancell.fastynet.cloud", "mtn.vcdn.online", "mtn.ma7ta.online", "mtnh.hamedgeek.top", "irc.jangal.icu"},
        "رایتل": {"rtl.ircf.space", "rtl.eqjgkx.xyz", "rtl.filna.cloud"},
        "مخابرات": {"mobin.nazario.top", "mbt.ircf.space"},
    }
    var result string
    for operator, domains := range operators {
