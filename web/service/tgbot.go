...
case "clo":
    numericKeyboardCloud := tu.InlineKeyboard(
        tu.InlineKeyboardRow(
            tu.InlineKeyboardButton("A").WithCallbackData("a"),
            tu.InlineKeyboardButton("B").WithCallbackData("b"),
        ),
        tu.InlineKeyboardRow(
            tu.InlineKeyboardButton("C").WithCallbackData("c"),
            tu.InlineKeyboardButton("D").WithCallbackData("d"),
        ),
    )
...
func (t *Tgbot) SendAnswer(chatId int64, msg string, isAdmin bool) {
	...
	numericKeyboardClient := tu.InlineKeyboard(
		tu.InlineKeyboardRow(
			...
			tu.InlineKeyboardButton("cloud").WithCallbackData("clo"),
		),
	)
