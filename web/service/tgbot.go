...
func (t *Tgbot) asnwerCallback(callbackQuery *telego.CallbackQuery, isAdmin bool) {
	...
	case "commands":
		...
		case "cloud":
    numericKeyboardCloud := tu.InlineKeyboard(
        tu.InlineKeyboardRow(
        ...
        tu.InlineKeyboardRow(
            ...
            tu.InlineKeyboardButton("مخابرات").WithCallbackData("mkb"),
        ),
        tu.InlineKeyboardRow(
    ...
    t.SendMsgToTgbot(chatId, "اینترنت خود را انتخاب کنید:", numericKeyboardCloud)
		case "mci":
    ...
    t.SendMsgToTgbot(chatId, t.getIPsForDomains(domainList))
    case "hwb":
    domainList := []string{"hwb.ircf.space", "hwb.eqjgkx.xyz", "hwb.myips.us.eu.org"}
    t.SendMsgToTgbot(chatId, t.getIPsForDomains(domainList))
    case "ast":
...
func (t *Tgbot) SendAnswer(chatId int64, msg string, isAdmin bool) {
	numericKeyboard := tu.InlineKeyboard(
		...
		tu.InlineKeyboardRow(
			tu.InlineKeyboardButton("آی پی سالم کلودفلر🍎").WithCallbackData("cloud"),
		),
	)
