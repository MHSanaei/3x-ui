...
type ClientTraffic struct {
	...
	// BilledUp/BilledDown are the per-client aggregate Billed Traffic (Real after
	...
	BilledUp   int64 `json:"billedUp" form:"billedUp" gorm:"default:0" example:"1048576"`
	BilledDown int64 `json:"billedDown" form:"billedDown" gorm:"default:0" example:"2097152"`
