...
var pwaAssets = map[string]pwaAsset{
	...
	"icons/3x-ui-192.svg":  {path: "dist/icons/3x-ui-192.svg", contentType: "image/svg+xml"},
	"icons/3x-ui-512.svg":  {path: "dist/icons/3x-ui-512.svg", contentType: "image/svg+xml"},
}
