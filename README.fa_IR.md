...
- **مبهم‌سازی کامل AmneziaWG 2.0** — ‏Jc/Jmin/Jmax (بسته‌های زباله)، S1–S4 (پدینگ بسته)، H1–H4 (سرآیندهای جادویی) و هر ۵ اسلات بسته‌ی امضا (I1–I5) — هرکدام با یک کلیک به‌صورت بسته‌ی شبیه‌سازی‌شده‌ی DNS/STUN/SIP/QUIC یا کاملاً تصادفی قابل تولیدند — همگی به‌ازای هر اینباند قابل ویرایش‌اند، به‌علاوه‌ی یک حالت سازگار با 1.x برای کلاینت‌های قدیمی‌تر.
