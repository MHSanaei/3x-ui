...
- **تمويه AmneziaWG 2.0 الكامل** — Jc/Jmin/Jmax (الحزم المهملة)، وS1–S4 (حشو الحزم)، وH1–H4 (الرؤوس السحرية)، وجميع فتحات حزم التوقيع الخمس (I1–I5) — يمكن توليد كل منها بنقرة واحدة كحزمة تحاكي DNS/STUN/SIP/QUIC، أو كرسالة ClientHello حقيقية بروتوكول TLS لمتصفح Chrome/Firefox/Safari، أو كعشوائية بحتة — جميعها قابلة للتعديل لكل اتصال وارد، بالإضافة إلى وضع متوافق مع 1.x للعملاء القدامى.
