...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: Generate a fresh Happ crypt5 representation of the current client
        subscription URL. The result is not stored or reused.
      url: '#generate-a-fresh-happ-crypt5-representation-of-the-current-client-subscription-url-the-result-is-not-stored-or-reused'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Generate a fresh Happ crypt5 representation of the current client
          subscription URL. The result is not stored or reused.
        id: generate-a-fresh-happ-crypt5-representation-of-the-current-client-subscription-url-the-result-is-not-stored-or-reused
