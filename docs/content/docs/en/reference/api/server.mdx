  ...
  toc:
    ...
    - depth: 2
      title: Run a live TLS 1.3 probe against a candidate REALITY target and return a
        ...
        the certificate SAN DNS names.
      url: '#run-a-live-tls-13-probe-against-a-candidate-reality-target-and-return-a-feasibility-verdict-tls-13--h2--x25519--trusted-certificate-plus-the-certificate-san-dns-names'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Run a live TLS 1.3 probe against a candidate REALITY target and return
          ...
          plus the certificate SAN DNS names.
        id: run-a-live-tls-13-probe-against-a-candidate-reality-target-and-return-a-feasibility-verdict-tls-13--h2--x25519--trusted-certificate-plus-the-certificate-san-dns-names
