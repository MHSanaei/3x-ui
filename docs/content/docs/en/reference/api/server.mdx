...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: Roll back the panel to a stable release version via local snapshot or
        online updater.
      url: '#roll-back-the-panel-to-a-stable-release-version-via-local-snapshot-or-online-updater'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Roll back the panel to a stable release version via local snapshot or
          online updater.
        id: roll-back-the-panel-to-a-stable-release-version-via-local-snapshot-or-online-updater
