...
const tabSlugs = ['general', 'security', 'telegram', 'email', 'subscription', 'subscription-formats', 'subscription-balancers'];
...
export default function SettingsPage() {
  ...
  const categoryBody = useMemo(() => {
    switch (activeSlug) {
      ...
      case 'subscription-balancers': return <SubscriptionBalancersTab allSetting={allSetting} updateSetting={updateSetting} />;
