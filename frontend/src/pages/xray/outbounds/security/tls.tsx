...
export default function TlsForm() {
  ...
  return (
    <>
      <FormField label={t('pages.inbounds.form.sni')} name={['streamSettings', 'tlsSettings', 'serverName']}>
        <Input placeholder={t('pages.xray.outboundForm.serverNamePlaceholder')} />
      </FormField>
      <FormField label={t('pages.inbounds.form.utls')} name={['streamSettings', 'tlsSettings', 'fingerprint']}>
        <Select
          allowClear
          placeholder={t('none')}
      ...
      <FormField label={t('pages.inbounds.form.alpn')} name={['streamSettings', 'tlsSettings', 'alpn']}>
        <Select mode="multiple" options={ALPN_OPTIONS} />
      </FormField>
      <FormField label={t('pages.inbounds.form.ech')} name={['streamSettings', 'tlsSettings', 'echConfigList']}>
        <Input />
      </FormField>
      <FormField
