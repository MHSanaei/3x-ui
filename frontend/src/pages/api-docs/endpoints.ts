...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary: "Manage the built-in reverse proxy that Xray's REALITY fallback target points at. The action parameter selects the operation.",
        params: [
      ...
      },
      {
        ...
        summary: 'Replace the reverse proxy decoy with an uploaded static site. The zip must contain an index.html, either at its root or inside a single wrapping folder.',
        params: [
