...
export type MasterClientCertProvider = unknown;
...
export interface ExternalLinkSync {
  clients: ExternalLinkSyncClient[];
  links: ExternalLinkSyncLink[];
}

export interface ExternalLinkSyncAssignment {
  enable: boolean;
  expiryTime: number;
  kind: string;
  namePrefix?: string;
...
export interface ExternalLinkSyncClient {
  email: string;
  links: ExternalLinkSyncAssignment[];
}

export interface ExternalLinkSyncLink {
  cacheTtl?: number;
  enable: boolean;
  expiryTime?: number;
  headers?: Record<string, string>;
