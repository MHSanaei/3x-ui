...
export type realityShortIDGenerator = unknown;
...
export interface Inbound {
  ...
  port: number;
  protocol: Protocol;
  realityShortIdsActiveCount: number;
  realityShortIdsGraceHours: number;
  realityShortIdsLastRotationTime: number;
  realityShortIdsNextRotationTime: number;
  realityShortIdsRetireAt: number;
  realityShortIdsRotationCount: number;
  realityShortIdsRotationCursor: number;
