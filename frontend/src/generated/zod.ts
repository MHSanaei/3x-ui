...
export const AllSettingSchema = z.object({
  ...
  oauthAdminGroup: z.string(),
  oauthClientId: z.string(),
  oauthClientSecret: z.string(),
  oauthEnable: z.boolean(),
  oauthGroupsClaim: z.string(),
  oauthIssuer: z.string(),
  oauthRedirectUrl: z.string(),
  oauthScopes: z.string(),
  oauthUserExpiryDays: z.number().int().min(0),
  oauthUserFlow: z.string(),
  oauthUserGroup: z.string(),
  oauthUserInboundRemark: z.string(),
  oauthUserLimitIP: z.number().int().min(0),
  oauthUserTotalGB: z.number().int().min(0),
  oauthUsernameClaim: z.string(),
...
export const AllSettingViewSchema = z.object({
  ...
  oauthClientSecret: z.string(),
  oauthEnable: z.boolean(),
  oauthEnvLocked: z.record(z.string(), z.boolean()),
  oauthGroupsClaim: z.string(),
  oauthIssuer: z.string(),
  oauthRedirectUrl: z.string(),
  oauthScopes: z.string(),
